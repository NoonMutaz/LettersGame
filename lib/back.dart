...
class back extends MyApp {
//  const start({super.key});

static const String screenRoute= 'back';
  @override
...
Container(margin:EdgeInsets.all(20),
  child:Text( 'Which animal starts with G',style:TextStyle(fontWeight:FontWeight.bold,fontSize:23,fontFamily:'Rubik'))
),
SizedBox(height: 10,),
//SizedBox(height: 150,),
